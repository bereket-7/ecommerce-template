...
import { ethiopianCities, nameExamples, phonePlaceholder } from "@/lib/ethiopia";
      ...
      <div className="bg-white shadow-1 rounded-[10px] p-4 sm:p-8.5">
        <div className="flex flex-col lg:flex-row gap-5 sm:gap-8 mb-5">
          <div className="w-full">
            ...
            <input
              ...
              name="firstName"
              id="firstName"
              placeholder={nameExamples.firstName}
          ...
          <div className="w-full">
            ...
            <input
              ...
              name="lastName"
              id="lastName"
              placeholder={nameExamples.lastName}
              className="rounded-md border border-gray-3 bg-gray-1 placeholder:text-dark-5 w-full py-2.5 px-5 outline-none duration-200 focus:border-transparent focus:shadow-input focus:ring-2 focus:ring-blue/20"
            />
          </div>
        </div>
        ...
        <div className="mb-5">
          ...
          <div className="relative">
            ...
            >
              <option value="ethiopia">{siteConfig.country}</option>
            </select>
        ...
        <div className="mb-5.5">
          ...
          <input
            ...
            name="email"
            id="email"
            placeholder={nameExamples.email}
            className="rounded-md border border-gray-3 bg-gray-1 placeholder:text-dark-5 w-full py-2.5 px-5 outline-none duration-200 focus:border-transparent focus:shadow-input focus:ring-2 focus:ring-blue/20"
          />
        </div>
